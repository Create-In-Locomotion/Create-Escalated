...
public class WalkwayPonders {
    ...
    public static void creatingWalkways(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(30);
        ElementLink<WorldSectionElement> walkwayShafts = scene.world.showIndependentSection(util.select.fromTo(5, 1, 1, 5, 1, 7), Direction.DOWN, 15);
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(6, 1, 1), Direction.WEST), Pointing.LEFT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(30);
        Object selectionSlot = new Object();
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(6, 1, 7), Direction.WEST), Pointing.LEFT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(15);
        scene.overlay.showOutline(PonderPalette.GREEN, selectionSlot, util.select.fromTo(6, 1, 1, 6, 1, 7), 30);
        scene.idle(15);
        scene.world.hideIndependentSectionImmediately(walkwayShafts);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(6, 1, 4), Pointing.DOWN)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick().whileSneaking(), 50);
        scene.idle(70);
        ...
        scene.idle(30);
        ElementLink<WorldSectionElement> escalatorShafts = scene.world.showIndependentSection(util.select.fromTo(1, 1, 1, 1, 4, 7), Direction.DOWN, 15);
        scene.world.moveSection(escalatorShafts, util.vector.of(1, 0, 0), 0);
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 1, 1), Direction.EAST), Pointing.RIGHT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 4, 7), Direction.EAST), Pointing.RIGHT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(15);
        scene.overlay.showOutline(PonderPalette.GREEN, selectionSlot, util.select.fromTo(2, 1, 1, 2, 4, 7), 50);
        scene.idle(15);
        scene.world.hideIndependentSectionImmediately(escalatorShafts);
        ...
        scene.overlay.showText(80)
                ...
                .colored(PonderPalette.BLUE);
        scene.idle(30);
        scene.overlay.showSelectionWithText(util.select.fromTo(2, 1, 1, 2, 1, 7), 80)
                .text("7 blocks long")
                .placeNearTarget();
        scene.idle(15);
        scene.overlay.showSelectionWithText(util.select.fromTo(2, 1, 7, 2, 4, 7), 65)
                .text("4 blocks tall")
                .placeNearTarget();
    ...
    public static void addingShaftsToWalkways(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 1, 2), Direction.NORTH), Pointing.RIGHT)
                .withItem(AllBlocks.SHAFT.asStack()).rightClick(), 50);
        scene.idle(40);
        ...
        scene.overlay.showText(80)
                ...
                .colored(PonderPalette.BLUE);
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(4, 1, 2), Direction.NORTH), Pointing.RIGHT)
                .withWrench().rightClick(), 50);
        scene.idle(40);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 1, 2), Direction.NORTH), Pointing.RIGHT)
                .withWrench().whileSneaking().rightClick(), 50);
        scene.idle(40);
    ...
    public static void customizingWalkways(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 1, 2), Pointing.DOWN)
                .withItem(new ItemStack(Items.YELLOW_DYE)).rightClick(), 50);
        scene.idle(40);
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 1, 2), Pointing.DOWN)
                .withItem(new ItemStack(Items.WATER_BUCKET)).rightClick(), 50);
        scene.idle(40);
        scene.world.modifyBlockEntityNBT(util.select.fromTo(0, 1, 2, 4, 1, 2), WalkwayBlockEntity.class, tag -> {
            tag.remove("Dye");
        });
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 1, 2), Pointing.DOWN)
                .withItem(AllItems.BELT_CONNECTOR.asStack()).rightClick(), 50);
        scene.idle(50);
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 2, 2), Direction.NORTH), Pointing.RIGHT)
                .withItem(new ItemStack(Items.RED_DYE)).rightClick(), 50);
        scene.idle(40);
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 2, 2), Direction.NORTH), Pointing.RIGHT)
                .withItem(new ItemStack(Items.GLASS)).rightClick(), 50);
        scene.idle(40);
    ...
    public static void wideningWalkways(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(30);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(0, 1, 3), Direction.WEST), Pointing.LEFT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(45);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(0, 1, 2), Direction.WEST), Pointing.LEFT)
                .withItem(EscalatedItems.METAL_WALKWAY_STEPS.asStack()).rightClick(), 30);
        scene.idle(15);
        ...
        scene.overlay.showSelectionWithText(util.select.fromTo(0, 2, 2, 4, 2, 3), 60)
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
